...
if(isset($_POST["submit"])){
	...
	if(empty($title)){
		...
		global $conn;
		$searchpara=$_GET['edit'];
		$query="Update posts SET dateTime='$DateTime', title='$title', category='$category', photos='$image', content='$content' where id='$searchpara'";
...
<html lang="en">
	<head>
	  <title>Infiniti | Edit Post </title>
	  <meta charset="utf-8">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				...
				?>
				<form action="editpost.php?edit=<?php echo $searchparam;  ?>" method="post" enctype="multipart/form-data">
				  <fieldset>
				  ...
				  <textarea class="form-control" name="post" id="title_post"> <?php echo $contenttoupdate;?> </textarea>
				  </div>
				  <div class="form-group">
