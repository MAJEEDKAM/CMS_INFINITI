...
if(isset($_POST["submit"])){
	...
	if(empty($name)||empty($password)||empty($cpassword)){
		...
		$_SESSION["ErrorMessage"]="password and conform password does not match";
		redirect_to("manageadmins.php");
	}else{
		global $conn;
		$query="insert into adminreg(datetime,name,addedby,pass)
...
<html lang="en">
	<head>
	  <title>Infiniti | Admin Panel </title>
	  <meta charset="utf-8">
			...
			<div class="col-sm-10">
				...
				<form action="manageadmins.php" method="post">
				  ...
				  <div class="form-group">
					...
					<input class="form-control" type="password" name="cpassword" id="cpassword" placeholder="Retype same password">
				  </div>
				...
				<?php
					global $conn;
					$viewquery="Select * from adminreg order by datetime desc";
				...
				<tr>
					...
					<td><a href="dltadmin.php?id=<?php echo $id;?>"><span class="btn btn-danger">Delete</span></td>
